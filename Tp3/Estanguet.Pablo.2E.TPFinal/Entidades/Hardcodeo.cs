...
namespace Entidades
{
    public static class Hardcodeo
    {
        public static void HardcodearTrabajadores()
        {
            ...
            Trabajador t8 = new Trabajador("Berta", "Chancle", 21, "Femenino", 40986325, "Lomas Del Mirador", "Soltera", 0, "Primario", false, true, 55);
        ...
        {
            Estudiante e1 = new Estudiante("Tomas", "Gago", 20, "Masculino", 428963254, "Ramos Mejia", "Soltero", 0, "Secundario", "UTN", "Terciario", "Programacion");
        ...
        public static void HardcodearJubilados()
        {
            ...
            Jubilado j4 = new Jubilado("Pedro", "Gareme", 65, "Maculino", 23658965, "Tapiales", "Casado", 2, "Secundario", 2021, true);
        ...
        public static void HardcodearEstudiantes_Trabajadores()
        {
            ...
            Estudiante_Trabajador et6 = new Estudiante_Trabajador("Valentin", "Dader", 23, "Maculino", 39625478, "Tapiales", "Soltero", 0, "Primario", "Mariano Moreno", "Secundario", "Bachiller", false, true, 45);
